        ...
        <div class="page-header min-vh-100">
          <div class="container">
            <div class="row">
                ...
                <div class="mt-8 border-0 card card-plain">
                  ...
                  <div class="card-body">
                    <form role="form" class="text-start">
                      ...
                      <div class="text-center">
                        <button
                          type="button"
                          class="mt-4 mb-0 btn btn-dark w-100"
                        >
                          Sign in
                        </button>
                      </div>
                  ...
                  <div class="px-1 pt-0 text-center card-footer px-lg-2">
                    <p class="mx-auto mb-4 text-sm">
                      ...
                      <a href="register.php" class="text-dark font-weight-bold"
                        >Sign up</a
                      >
                    </p>
                  </div>
              ...
              <div class="col-md-6">
                <div
                  class="top-0 position-absolute w-45 h-100 d-md-block end-0 d-none"
                >
                  <div
                    class="bg-cover position-absolute fixed-top me-n8 border-radius-lg ms-auto h-100 z-index-0"
                    style="
